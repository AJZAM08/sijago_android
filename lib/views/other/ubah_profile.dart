...
import 'package:sijago_android/views/home/pages/profile_page.dart';

import '../../../../core/components/custom_appbar.dart';
import '../../../../core/constant/colors.dart';
import '../../core/assets/assets_gen.dart';
import '../../core/constant/textsytle.dart';
import '../home/widget/profile_widget/button_ubah.dart';
import '../home/widget/profile_widget/form_ubah.dart';
import '../home/widget/profile_widget/list_ubah.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            SizedBox(height: 15,),
            ButtonUbah(label: 'Simpan Perubahan', onPressed: (){Get.to(() => ProfilePage());}),
            SizedBox(height: 15,),
            ListUbah(),

...
import '../profile_risk/widget/button_bayar.dart';

class SwitchProd extends StatelessWidget {
  @override
...
class Switc extends StatefulWidget {
  @override
  _SwitcState createState() => _SwitcState();
}
        ...
        children: [
          ...
          Column(
            children: [
              ...
              ButtonPayment(label: 'Witch Produk', onPressed: (){}),
            ],
          ),
        ],
      ),

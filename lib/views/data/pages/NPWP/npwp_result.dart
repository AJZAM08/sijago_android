...
class ResultNPWP extends StatelessWidget {
  const ResultNPWP({super.key});
          ...
          children: [
                  ...
                  Stack(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Image.file(File(cameraCtrl.imagePathNPWP.value)),
                      ),
                    ],
                  ),
                ],
            ...
            Padding(
              ...
              child: MyButton(
                label: 'Selanjutnya',
                onPressed: () {
                  Get.toNamed(RouteName.bankPencairan);
                },
